    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ForesightPool.Market",
        "components": [
          {
            "name": "creator",
            "type": "address",
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "side",
        "type": "uint8",
        "internalType": "enum ForesightPool.Side"
      },
      {
        "name": "amount",
        "type": "uint256",
    ...
    "inputs": [
      {
        "name": "c",
        "type": "tuple",
        "internalType": "struct AttestedScoreResolver.Config",
        "components": [
          {
            "name": "eventKey",
            "type": "bytes32",
    ...
    "inputs": [
      {
        "name": "c",
        "type": "tuple",
        "internalType": "struct MentoPriceResolver.Config",
        "components": [
          {
            "name": "rateFeedId",
            "type": "address",
          ...
          },
          {
            "name": "comparator",
            "type": "uint8",
            "internalType": "enum MentoPriceResolver.Comparator"
          },
          {
            "name": "maxStaleness",
            "type": "uint64",
...
export const chainMetricResolverAbi = [
  {
    "type": "function",
    "name": "READ_GAS_LIMIT",
    "inputs": [],
    ...
    "inputs": [
      {
        "name": "c",
        "type": "tuple",
        "internalType": "struct ChainMetricResolver.Config",
        "components": [
          {
            "name": "target",
            "type": "address",
          ...
          },
          {
            "name": "comparator",
            "type": "uint8",
            "internalType": "enum ChainMetricResolver.Comparator"
          }
        ]
      }
    ],
...
export const testnetSortedOraclesAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
